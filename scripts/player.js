class Player {
	...
	getRandomChipType(){
		...
		console.log(`Chip supply: 1-6 ${this.chipSupply[0]} 2-5 ${this.chipSupply[1]} 3-4 ${this.chipSupply[2]}`);
		console.log(`Chances: 1-6 ${typeOneSixChipChance} 2-5 ${typeTwoFiveChance} 3-4 ${typeThreeFourChance}`);
		do {
